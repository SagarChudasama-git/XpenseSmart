...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTransactionSummary() {
        ...
        document.querySelector('.summary-item.budget .amount').textContent = `₹${totalBudget.toFixed(2)}`;
        document.querySelector('.summary-item.used .amount').textContent = `₹${totalUsed.toFixed(2)}`;
        document.querySelector('.summary-item.remaining .amount').textContent = `₹${remaining.toFixed(2)}`;
    }
        ...
        budgets.forEach(budget => {
            ...
            budgetItem.innerHTML = `
                <div class="budget-info">
                    ...
                    <p class="budget-amount">Budget: ₹${budget.amount.toFixed(2)}</p>
                    <p class="spending-amount">Spent: ₹${spending.toFixed(2)}</p>
                </div>
